...
import "../../styles/EventDetailSpectator.css"
function EventDetailSpectator(){
    const event = {
        id:"1",
        ...
        EventMedias: [
            {Id: "1", EventId:"1", MediaId: "1",MediaDTO:{Id:"1",Url:"../../assets/fpt-campus.jpg"}},
            {Id: "2", EventId:"1", MediaId: "2",MediaDTO:{Id:"2",Url:"../../assets/banner-item-3.jpg"}}
        ],
    };
    ...
    return (
        <div className="p-2">
            <div className="d-flex flex-wrap m-5 align-items-end">
                ...
                <span className="fs-6 p-1">{event.StartTime} - {event.EndTime}</span>
            </div>
...
export default EventDetailSpectator;